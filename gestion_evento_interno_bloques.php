...
<head>
    ...
    <title>Gestión Evento Interno Sesiones</title>
...
<link href="jquery.datetimepicker.css" rel="stylesheet">
    ...
    <link href=
    'https://fonts.googleapis.com/css?family=Kaushan+Script' rel='stylesheet' type='text/css'>
...
<body id="page-top" class="index">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                       	 <?php //inicio PHP	
								...
								$nombre = mysql_query('SELECT usuario_interno_id_usuario_interno FROM evento_interno WHERE fecha_solicitud="'.mysql_real_escape_string($fecha_sistema).'"');
						
								
								
								while ($row = mysql_fetch_row($nombre)){
									
									$usu = mysql_query('SELECT * FROM usuario_interno WHERE id_usuario_interno="'.mysql_real_escape_string($row[0]).'"');
    ...
    <section id="contact" style="background-repeat: repeat; background-position:top;">
        <div class="container">
            ...
            <form name="sesiones" action="clases/registro_evento_interno_horas.php" enctype="multipart/form-data" method="post"  novalidate>
             <?php 
                            ...
                            <div class="col-md-6">
                               <h3 style="margin-left: 17%; color: white; font-size: 30px; font-weight: bold;">Datos de la sesión <?php echo $contador_bloques ?></h3>
                                <div class="form-group">
                                    <input name="fecha<?php echo $contador_bloques?>" type="text" id="datetimepicker" class="form-control">
