...
<body id="page-top" class="index">
   ...
   <!-- Barra Navegación -->
    ...
    <!-- Sección Login Evento Interno -->
    <section id="contact">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Ingresar a Evento Externo</h2>
                    <h3 class="section-subheading text-muted"></h3>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <form name="login_evento_interno" action="clases/login_externo.php" method="post"  novalidate>
                        <div class="row">
                            <div class="col-md-6" style="margin-left: 25%">
                                ...
                                <div class="form-group">
                                    <input type="text" name="password" class="form-control" placeholder="Por favor escriba su rif" id="name" required data-validation-required-message="Por favor escriba su rif">
                                    <p class="help-block text-danger"></p>
                                </div>
                                
                                <div class="form-group">
                                    <a href="registrar_usuario_externo.php"><h6 style="color: white; margin-left: 39%;">Resgistrese aqui</h6></a>
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
	...
	<!-- Fin Sección Login Evento Interno -->
