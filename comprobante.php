    ...
    <section id="contact">
        <div class="container">
            ...
            <div class="row">
               <!-- datos personales -->
                <div class="col-lg-12"> 
                    <form name="formulario_registro" method="post" novalidate>
                        <div class="row">    
                            <div class="col-md-6">
	...
	<!-- FIn Sección comprobante datos personales y evento -->
					...
					<section id="contact" style="background-repeat: repeat; background-position:top;">
						...
						<?php 
						   //se envia la consulta  
							...
							//se guarda variable de dia incio ordenano
								$fecha_in = substr($row_sesiones[3], 8, 4);
								$mes_in = substr($row_sesiones[3], 5, 2);
								$ano_in = substr($row_sesiones[3], 0, 4);
								
								//se guarda variable de dia fin ordenano
								$fecha_fin = substr($row_sesiones[4], 8, 4);
								$mes_fin = substr($row_sesiones[4], 5, 2);
								$ano_fin = substr($row_sesiones[4], 0, 4);
				...
				<div class="row">
                            ...
                            <div class="col-md-6">
                               <h3 style="margin-left: 17%; color: white; font-size: 30px; font-weight: bold;">Datos de la sesión <?php echo $contador_bloques_sesiones ?></h3>
                                <div class="form-group">
                                    <input name="fecha" value="Fecha inicial de la sesión: <?php echo $fecha_in."/".$mes_in."/".$ano_in ?> | Fecha final de la sesión: <?php echo $fecha_fin."/".$mes_fin."/".$ano_fin ?>"  class="form-control" disabled>
					...
					$contador_bloques_sesiones++;								
                        ...
                        <div class="col-lg-12 text-center">
                                <div id="success"></div>
                               <a href="agregar_calendario.php?evento=<?php echo $id_evento?>"><button style="margin-top: 5%;" type="submit" class="btn btn-xl">Finalizar</button></a> 
