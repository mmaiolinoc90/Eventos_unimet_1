...
<head>
    ...
    <title>Gestión Evento Externo</title>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                       	 <?php //inicio PHP	
								...
								$nombre = mysql_query('SELECT * FROM usuario_externo WHERE correo="'.mysql_real_escape_string($id_usuario_externo).'"');
        ...
        <div class="container">
            ...
            <div class="row">
               <!-- formulario de datos personales -->
                <div class="col-lg-12"> 
                    <form name="formulario_registro" action="clases/resgistro_evento_externo.php" method="post" enctype="multipart/form-data" novalidate>
                        <div class="row">    
                            <div class="col-md-6">
                              <h3 style="margin-left: 20%; color: white; font-size: 30px; font-weight: bold;">Datos Personales</h3>
                               ...
                               echo '</div>';
                                ...
                                echo '</div>';	
								echo '<div class="form-group">';
                                   echo '<input type="tel" value="'.$row[5].'" disabled class="form-control" id="telefono" name="telefono">';
                                    echo '<p class="help-block text-danger"></p>';
                                echo '</div>';
								echo '<div class="form-group">';
                                   echo '<input value="'.$row[6].'" disabled class="form-control" id="empresa" name="empresa">';
                                    echo '<p class="help-block text-danger"></p>';
                                echo '</div>';
								echo '<div class="form-group">';
                                   echo '<input value="'.$row[7].'" disabled class="form-control" id="cargo" name="cargo">';
                                    echo '<p class="help-block text-danger"></p>';
                                echo '</div>';
                            ...
                            <div class="col-md-6">
                               ...
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                  	<h5 style="color: white; float: left;">¿Requiere Entradas para el evento? </h5>
                                   	<input style="float: left; width: 30px; height: 30px;" name="entradas" id="entradas"  type="checkbox" value="SI" />
                                </div>  
