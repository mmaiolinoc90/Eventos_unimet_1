...
mysql_query("INSERT INTO agenda_externa (id_usuario_externo, id_evento_externo, fecha_inicio, fecha_fin, hora_inicio, hora_fin, localidad_id_localidad, servicio_adicional, servicios_id_servicios, Cantidad_servicios, Observaciones) VALUES ('$_POST[id_usuario_externo]', '$_POST[id_evento]', '".$fecha."' , '".$fecha."', '".$hora_ini."', '".$hora_final."', '".$localidad."','".$servicio_adicional."','".$cadena_servicios."','".$cadena_cantidad."','".$observaciones."' )", $conexion);
}


echo '<script> window.location="../comprobante_evento_externo.php?evento='.$id_evento.'"</script>';  
?>
